      ...
      <Grid container spacing={2} alignItems="center" justifyContent="center">
        ...
        <Grid item sm={6} xs={12} sx={{ order: { xs: 1, sm: 0 } }}>
          <Typography variant="body1" gutterBottom>
            ...
            را سخت می‌کند. انتظار می‌رود در این شرایط، سرمایه‌گذاران خطرپذیر که
            عموما روی کسب و کارهای نوپا Startup سرمایه‌گذاری می‌کنند، تامین
            سرمایه را تسهیل کنند، اما شاهد این هستیم که به سبب ریسک کمتر و امکان
            ارزش‌گذاری دقیق‌تر، استراتژی‌هایشان را بر سرمایه‌گذاری روی گروه‌هایی
